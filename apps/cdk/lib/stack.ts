...
export class DebugStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const repoApp = new ecr.Repository(this, "RepositoryApp", {
      repositoryName: "repo-cdk-hono-template-app",
    ...
    const repoMigrate = new ecr.Repository(this, "RepositoryMigrate", {
      repositoryName: "repo-cdk-hono-template-migrate",
      imageScanOnPush: false,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
      emptyOnDelete: true,
      lifecycleRules: [
    ...
    const repoJump = new ecr.Repository(this, "RepositoryJump", {
      repositoryName: "repo-cdk-hono-template-jump",
      imageScanOnPush: false,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
      emptyOnDelete: true,
      lifecycleRules: [
    ...
    // vpc.addGatewayEndpoint("DSQLEndpoint", {
    //   service: ec2.InterfaceVpcEndpointAwsService.DSQL_MANAGEMENT,
    //   subnets: [{ subnetType: ec2.SubnetType.PRIVATE_ISOLATED }],
    // });
    ...
    const dbSecret = new Secret(this, "DBSecret", {
      secretName: "debug-app-aurora-credentials",
    ...
    const jumpBoxSg = new ec2.SecurityGroup(this, "JummpBoxSg", {
      vpc,
      allowAllOutbound: true,
    });
    ...
    dbSg.addIngressRule(jumpBoxSg, ec2.Port.tcp(5432));
    ...
    const aurora = new rds.DatabaseCluster(this, "AuroraCluster", {
      clusterIdentifier: "debug-aurora-app",
      engine: rds.DatabaseClusterEngine.auroraPostgres({
        version: rds.AuroraPostgresEngineVersion.VER_17_5,
      }),
    ...
    const cluster = new ecs.Cluster(this, "FargateCluster", {
      clusterName: "debug-aurora-cluster",
      vpc,
    });
    ...
    new Bucket(this, "DebugS3", {
      bucketName: "debug-bukect-x056",
    ...
    const provider = new iam.OpenIdConnectProvider(this, "GitHubProvider", {
      ...
      thumbprints: [
        ...
        "a031c46782e6e6c662c2c87c76da9aa62ccabd8c",
      ],
    });

    const oidcrole = new iam.Role(this, "GitHubOidcRole", {
      roleName: "oidc-role-github-actions",
        ...
        provider.openIdConnectProviderArn,
        {
          StringLike: {
            "token.actions.githubusercontent.com:sub": [
              "repo:tinytale/cdk-hono-rds-template:*",
            ],
          },
        },
    ...
    new cdk.CfnOutput(this, "JumpBoxSecurityGroupId", {
      value: jumpBoxSg.securityGroupId,
    });
