...

{
  ...
  containerDefinitions: [
    {
      name: 'migrate',
      image: cfn_output(stack_name, 'RepoMigrateURI') + ':latest',
      environment: [
      ...
      secrets: [
        ...
        { name: 'DB_USERNAME', valueFrom: cfn_output(stack_name, 'DbSecretArn') + ':username::' },
      ...
      logConfiguration: {
        logDriver: 'awslogs',
        options: {
          'awslogs-group': cfn_output(stack_name, 'MigrateLogGroupName'),
